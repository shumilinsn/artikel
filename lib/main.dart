...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const HomeScreen(title: 'Deutsche Artikel'),
    );
  }
}
        ...
        child: Column(
          ...
          children: <Widget>[
            ElevatedButton(
              ...
              child: const Text('Artikel Trainieren'),
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const ArtikelTrainierenRoute()),
                );
              },
            ),
            SizedBox(height: 20),
            ElevatedButton(
              ...
              child: const Text('Wort finden'),
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => WortFindenRoute()),
                );
              },
            ),
          ],
